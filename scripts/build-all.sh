...
# 构建 Python 包
echo -e "${YELLOW}🔨 步骤 3/4: 构建 Python 包...${NC}"
python -m build
echo -e "${GREEN}   ✓ Python 包构建完成${NC}"
echo ""

# 打包 skills
echo -e "${YELLOW}📦 步骤 4/4: 打包 skills...${NC}"
...
echo "======================================"
echo ""
echo -e "${BLUE}📦 Python 包:${NC}"
ls -lh dist/
echo ""
echo -e "${BLUE}📦 Skills 包:${NC}"
ls -lh skills-dist/
echo ""
echo "======================================"
...
echo "   - skills-dist/goalcast-skills-${SKILLS_VERSION}.tar.gz"
echo ""
echo "======================================"
echo ""
