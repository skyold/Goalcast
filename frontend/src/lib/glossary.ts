...
export const glossary = {
  ...
  // Phase 4 占位
  'dash.candidates':
    '候选比赛：未来 7 天内可分析比赛数。「已选 / 全部」= 你选中的联赛 / 所有联赛。',
  'dash.ai_modeled':
    'AI 已建模：未来 7 天已生成预测结果的比赛数。「已选 / 全部」= 你选中的联赛 / 所有联赛。',
  'dash.drop_high':
    '高跌幅：24h 内主胜赔率跌幅 ≥50% 的比赛数。「已选 / 全部」= 你选中的联赛 / 所有联赛。',
  'dash.predictability':
    '已建模比赛：未来 7 天模型覆盖等级 ≥「弱建模」的比赛数。「已选 / 全部」= 你选中的联赛 / 所有联赛。',
  'dash.top_drops':
