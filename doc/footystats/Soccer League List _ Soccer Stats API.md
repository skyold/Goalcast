...
## Get Leagues
`GET` `https://api.football-data-api.com/league-list?key=YOURKEY` Sample Response (Access the URL below)
[https://api.football-data-api.com/league-list?key=example](https://api.football-data-api.com/league-list?key=example) Returns a JSON array of all leagues available in the API Database. Each season of a competition gives a unique ID.
#### Query Parameters
