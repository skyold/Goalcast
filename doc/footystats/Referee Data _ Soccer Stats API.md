...
## Get Referee
`GET` `https://api.football-data-api.com/referee?key=YOURKEY&referee_id=*` Returns an array of stats of the referee for all competitions and seasons they participated in.
#### Query Parameters
